...
const FeaturedPostCard = ({ post }) => (
  <div className="relative h-72">
    <div className="absolute rounded-3xl bg-center bg-no-repeat bg-cover shadow-md inline-block w-full h-72" style={{ backgroundImage: `url('${post.featuredImage.url}')` }} />
    <div className="absolute rounded-3xl bg-center bg-gradient-to-b opacity-50 from-gray-400 via-gray-700 to-black w-full h-72" />
        ...
        <p className="text-white mb-4 text-shadow font-semibold text-2xl text-center">{post.title}</p>
            <div className="flex items-center absolute bottom-5 w-full justify-center">
                ...
                height="30px"
                width="30px"
                className="align-middle drop-shadow-lg rounded-3xl"
